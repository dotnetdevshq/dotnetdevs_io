...
export const isStaging = process.env.SITE_NOINDEX === '1' || (process.env.CF_PAGES === '1' && !!process.env.CF_PAGES_BRANCH && process.env.CF_PAGES_BRANCH !== (process.env.SITE_PRODUCTION_BRANCH || 'main'));
